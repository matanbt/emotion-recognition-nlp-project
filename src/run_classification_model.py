...
def main(cli_args):
    ...
    if args.do_train:
        global_step, tr_loss = train(args, model, tokenizer, train_dataset, evaluate_classification_model, dev_dataset, test_dataset)
    ...
    if args.do_eval:
        ...
        for checkpoint in checkpoints:
            ...
            model.to(args.device)
            result = evaluate_classification_model(args, model, test_dataset, mode="test", global_step=global_step)
